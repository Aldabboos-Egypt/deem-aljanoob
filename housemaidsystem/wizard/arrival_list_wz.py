...
class ArrivalListWz(models.TransientModel):
    _name = "housemaidsystem.wizard.arrival_list_wz"
    _description = "Arrival List Wizard"

    from_date = fields.Date(string="Arrival From Date")
    to_date = fields.Date(string="Arrival To Date")
    ...
    def print_report(self):
        ...
        report = self.env.ref('housemaidsystem.arrival_list_rep_wiz_action')
