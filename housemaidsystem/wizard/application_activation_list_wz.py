...
class ApplicationActivationWz(models.TransientModel):
    _name = "housemaidsystem.wizard.application_activation_wz"
    _description = "Applications Activation Wizard"
    ...
    def print_report(self):
        ...
        report = self.env.ref('housemaidsystem.application_activation_rep_wiz_action')
