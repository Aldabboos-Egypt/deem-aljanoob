...
class ReservationsListWz(models.TransientModel):
    _name = "housemaidsystem.wizard.application_list_wz"
    _description = "Applications List Wizard"
    ...
    def print_report(self):
        ...
        report = self.env.ref('housemaidsystem.application_list_rep_wiz_action')
